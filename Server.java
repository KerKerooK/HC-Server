...
public class Server {
    public static void main(String[] args) {
        try {
            ...
            DataBase.getInstance().addDataBase("UsersBasicInfo", new Controller("data/UsersBasicInfo.txt"));
            DataBase.getInstance().addDataBase("Flights", new Controller("data/Flights.txt"));
            DataBase.getInstance().addDataBase("Budget", new Controller("data/Budget.txt"));
            DataBase.getInstance().addDataBase("BuyedFlights", new Controller("data/BuyedFlights.txt"));
            DataBase.getInstance().addDataBase("Transactions", new Controller("data/Transactions.txt"));
            DataBase.getInstance().addDataBase("DiscountCodes", new Controller("data/DiscountCodes.txt"));
            DataBase.getInstance().addDataBase("UsersInfo", new Controller("data/UsersInfo.txt"));
            DataBase.getInstance().addDataBase("CompaniesBasicInfo", new Controller("data/CompaniesBasicInfo.txt"));
            DataBase.getInstance().addDataBase("Companies", new Controller("data/Companies.txt"));
